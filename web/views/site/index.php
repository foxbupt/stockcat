<div class="container">
	<ul>
		...
		<li><a href="<?php echo Yii::app()->createUrl('/stock/pool/candle'); ?>">蜡烛形态</a></li>
	...
	<ul>
		...
		<li><a href="<?php echo Yii::app()->createUrl('/stock/pool/candle', array('location' => CommonUtil::LOCATION_US)); ?>">蜡烛形态</a></li>
