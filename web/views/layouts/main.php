							...
							<ul class="nav">
								...
								<li class="dropdown">
								  <a class="dropdown-toggle" id="poolMenu" data-toggle="dropdown">
								    	A股 <span class="caret"></span>
								  </a>
								  <ul class="dropdown-menu" role="menu" >
								    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/index'); ?>">股票池</a></li>
								    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/realtime'); ?>">实时上涨列表</a></li>
								    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/rankList'); ?>">评级列表</a></li>
								    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/threshold'); ?>">价格突破列表</a></li>
								    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/upresist'); ?>">趋势突破列表</a></li>
								    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/uplimit'); ?>">昨日涨停列表</a></li>
								    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/candle'); ?>">蜡烛形态</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/rapid', array('rise' => 1)); ?>">快速拉升列表</a></li>
									<li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/rapid', array('rise' => 0)); ?>">快速下跌列表</a></li>
								  </ul>
								</li>
								...
								<li class="dropdown">
								  <a class="dropdown-toggle" id="poolMenu" data-toggle="dropdown">
								    	美股 <span class="caret"></span>
								  </a>
								  <ul class="dropdown-menu" role="menu" >
								    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo Yii::app()->createUrl('/stock/pool/index', array('location' => CommonUtil::LOCATION_US)); ?>">股票池</a></li>
