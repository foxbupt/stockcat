<div class="container-fluid">
	<div class="row">
		<div class="span4">
			<div style="float:left;height:40px;overflow:hidden;background:url(http://mat1.gtimg.com/finance/images/stock/p/hqhk_gg/hqpanel_v1.1/sprite-repeat.png) 0 0 repeat-x;">
				...
				<h1 style="background: transparent; font-size: 11px; line-height: 22px; margin-top: -7px; "><?php echo CommonUtil::getShowCode($stockInfo['code'], $stockInfo['ecode']); ?></h1>
			</div>
		</div>
		<div class="span8">
