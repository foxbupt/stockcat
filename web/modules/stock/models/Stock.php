...
class Stock extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('hist_high, hist_low, year_high, year_low, month6_high, month6_low, month3_high, month3_low', 'length', 'max'=>6),
			array('capital, out_capital, profit, assets, dividend', 'length', 'max'=>8),
