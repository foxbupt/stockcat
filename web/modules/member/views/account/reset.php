<div class="container">
	<div class="row">
		<div class="offset1 span6">
			...
			<div>
				<?php if (!$success): ?>
				<form id="resetForm" method="post" class="form-horizontal" onsubmit="return submitResetForm();" >
					...
					<div class="control-group">
						<div class="controls">
						    <button class="btn btn-primary btn-large" id="reset" type="submit">提交</button>
						</div>
					</div>
				</form>
				<?php else: ?>
