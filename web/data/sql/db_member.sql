 ...
 */
CREATE TABLE IF NOT EXISTS `t_user_hold`
(
	`id`        int(11) unsigned NOT NULL AUTO_INCREMENT,
	`batch_no`  int(11) unsigned NOT NULL default 0 COMMENT '批次编码, 格式为YYYYmmdd',
	`uid`       int(11) NOT NULL default 0 COMMENT '用户uid',
	`sid`       int(11) NOT NULL default 0 COMMENT '股票id',
	`count`     int(11) NOT NULL default 0 COMMENT '持有数量',
    `price`     decimal(6,2) NOT NULL default 0 COMMENT '每股买入成本单价',
    `cost`      decimal(10,2) NOT NULL default 0 COMMENT '买入成本',
...
(
	...
	`commission` decimal(10,2) NOT NULL default 0.0 COMMENT '佣金费用',
	`tax`       decimal(10,2) NOT NULL default 0.0 COMMENT '税率费用',
